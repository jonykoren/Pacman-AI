...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        # Define the initial starting position by getting it's specific corners
        # We dont want the first one
        # Check if the starting position is a corner, specify by returning true or false for corners
    ...
    def isGoalState(self, state):
        ...
        # Answering the question whether the search state is a goal state or not
        # If all corners are visited state[1:] will return true
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                # Check if the next position is a corner, if yes return true for that corner
...
def foodHeuristic(state, problem):
    ...
    """
    # Getting the position and food positions by the state
    ...
    for i in foodGrid.asList():
        ...
        """
        # Create heuristics with two different metrics
        max_dis = max(max_dis, mazeDistance(position, i, problem.startingGameState))
        # max_dis = max(max_dis, manhattanDistance(position, i))
    return max_dis
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        """search all the food with breadth first search to always eat the closest food"""
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # Getting the food to eat position
